...
function CNV() {
  ...
  const handleSubmit = () => {
    ...
    const formData= {
      ...
      Coverageanddepth:selectedValues[2],
      fundamentalconcepts:selectedValues[4],
       oralpresentation:selectedValues[5],
      think:selectedValues[6],
      transparent:selectedValues[9],
      overall:selectedValues[10],
      Examination:selectedValues[8],
      knowledgeSkill:selectedValues[3],
       approachability:selectedValues[7]
    };
    axiosClient.post("feedback/cnv", formData)
      .then((response) => {
  ...
  return (
    <>
      <div className="flex  mx-auto w-[800px] mt-5 flex-col rounded-lg p-4   pb-10 gap-4">
                <BlackBox
          subject="Consciousness and Values"
